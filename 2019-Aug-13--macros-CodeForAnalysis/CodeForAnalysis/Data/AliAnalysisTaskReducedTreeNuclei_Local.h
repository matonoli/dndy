#ifndef AliAnalysisTaskReducedTreeNuclei_Local_cxx
#define AliAnalysisTaskReducedTreeNuclei_Local_cxx
...
class AliAnalysisTaskReducedTreeNuclei_Local : public AliAnalysisTaskSE {
   
public:
   AliAnalysisTaskReducedTreeNuclei_Local();
   AliAnalysisTaskReducedTreeNuclei_Local(const char *name);
   virtual ~AliAnalysisTaskReducedTreeNuclei_Local();
...
private:
   ...
   AliAnalysisTaskReducedTreeNuclei_Local(const AliAnalysisTaskReducedTreeNuclei_Local&);
   AliAnalysisTaskReducedTreeNuclei_Local& operator=(const AliAnalysisTaskReducedTreeNuclei_Local&);
   
   ClassDef(AliAnalysisTaskReducedTreeNuclei_Local, 3);
};
#endif
