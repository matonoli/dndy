...
#ifndef ROOT_TFeldmanCousins2
#define ROOT_TFeldmanCousins2
...
class TFeldmanCousins2 : public TObject {
protected:
  ...
  Double_t fUnc;        // input systematic uncertainty
...
public:
   TFeldmanCousins2(Double_t newCL=0.9, TString options = "");
   virtual ~TFeldmanCousins2();
   ...
   ////////////////////////////////////////////////
   Double_t CalculateUpperLimit(Double_t Nobserved, Double_t Nbackground, Double_t Uncertainty = 0.);
   Double_t CalculateLowerLimit(Double_t Nobserved, Double_t Nbackground, Double_t Uncertainty = 0.);
  ...
  inline void     SetUncertainty(Double_t Unc)        { fUnc = Unc;   }
  ...
  Double_t Prob(Int_t N, Double_t mu, Double_t B, Double_t Unc = 0.);

   ClassDef(TFeldmanCousins2,1) //calculate the CL upper limit using the Feldman-Cousins method
};
